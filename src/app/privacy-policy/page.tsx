      ...
      <div className="privacy-policy-area ptb-100 dark:bg-slate-900 dark:text-white">
        <div className="container">
          <div className="privacy-policy">
            <div className="title">
              <h2 className="dark:text-white">Nezox Privacy Policy</h2>
              <p>This policy was last updated september 20, 2024.</p>
            </div>

            <div className="privacy-content">
              <h3 className="dark:text-white">Information collection</h3>
              <p>
            ...
            <div className="privacy-content">
              <h3 className="dark:text-white">1. General information</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut abore et dolore magna aliqua. Ut
                enim ad minim veniam, quis nostrud exercitation ullamco laboris
            ...
            <div className="privacy-content">
              <h3 className="dark:text-white">2. Personal data collected</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut abore et dolore magna aliqua. Ut
                enim ad minim veniam, quis nostrud exercitation ullamco laboris
