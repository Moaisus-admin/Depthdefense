        ...
        <div className="container">
          <div className="terms-conditions">
            <div className="title ">
              ...
              <h2 className="dark:text-white">Nezox Terms of Service</h2>
            </div>
            ...
            <div className="conditions-content">
              <h3 className="dark:text-white">2. General Conditions</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut abore et dolore magna aliqua. Ut
                enim ad minim veniam, quis nostrud exercitation ullamco laboris
            ...
            <div className="conditions-content">
              <h3 className="dark:text-white">4. Entire Agreement</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut abore et dolore magna aliqua. Ut
                enim ad minim veniam, quis nostrud exercitation ullamco laboris
            ...
            <div className="conditions-content">
              <h3 className="dark:text-white">5. Service Rules</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut abore et dolore magna aliqua. Ut
                enim ad minim veniam, quis nostrud exercitation ullamco laboris
            ...
            <div className="conditions-content five mb-0">
              <h3 className="dark:text-white">6. Limitation of Liability</h3>
              <p className="mb-0">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut abore et dolore magna aliqua. Ut
                enim ad minim veniam, quis nostrud exercitation ullamco laboris
